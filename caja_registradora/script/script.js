document.addEventListener("DOMContentLoaded", function () {
    // Obtener los elementos del DOM necesarios para operar
    const iniciarCajaBtn = document.getElementById("start_box");
    const registrarVentaBtn = document.getElementById("register_sale");
    const procesarPagoBtn = document.getElementById("process_payment");
    const total = document.getElementById("total_sales")
    const cerrarCaja = document.getElementById("close_box")
    const visor = document.getElementById("lector");
    const limpiarVisor = document.getElementById("turn_off")


    // estado inicial de la caja registradora y las ventas
    ...
    limpiarVisor.addEventListener("click",function(){
        visor.textContent = "";
    })
});
